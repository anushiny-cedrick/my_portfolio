...
//     <div id="Project" className='w-ful px-[12%] py-10 scrol-mt-20'>
//         <h4 className='text-center mb-2 text-lg'>Progressing</h4>
//         <h2 className='text-center text-3xl'>My latest projects</h2>
//         <p className='text-center max-w-2xl mx-auto mt-5 mb-12'>My various work showing my expertise in various domains</p>
...
//                     </div>
//                 </div>
//                 <Link to="/web-design">Explore More</Link>
//             </div>
//             {/* Web Design Project */}
...
//                     </div>
//                 </div>
//                 <Link to="/cloud">Explore More</Link>
//             </div>
//             {/* Cloud Project */}
...
//                     </div>
//                 </div>
//                 <Link to="/data-analysis">Explore More</Link>
//             </div>
//             {/* Data Analyst project */}
...
//                     </div>
//                 </div>
//                 <Link to="/devops">Explore More</Link>
//             </div>
//             {/* DevOps projects */}
...
//                     </div>
//                 </div>
//                 <Link to="/machine-learning">Explore More</Link>
//             </div>
//             {/* Machine Learning  */}
//         </div>
//     </div>
